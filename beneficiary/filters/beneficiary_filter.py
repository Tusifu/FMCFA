...
class BeneficiaryFilter(django_filters.FilterSet):
    ...
    def Beneficiary_custom_filter(self, queryset, name, value):
        return Beneficiary.objects.filter(
            Q(name__icontains=value) | Q(address__icontains=value) |  Q(age__icontains=value) | Q(district__icontains=value) | Q(sector__icontains=value) | Q(province__icontains=value)).order_by("id")
